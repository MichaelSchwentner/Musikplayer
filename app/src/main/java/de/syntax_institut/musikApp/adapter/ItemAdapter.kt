...
class ItemAdapter(
    ...
    inner class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val cardciewClicker = itemView.findViewById<CardView>(R.id.item_cardView)
    }
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        // TODO Schreibe hier deinen Code
        val cardView = holder.cardciewClicker
        // Setze Attribute
        ...
        cardView.setOnClickListener{
            ...
            intent.putExtra("imageResource", song.imageResource)
            intent.putExtra("stringResource", song.stringResource)
